...
const EventPage = async ({ params: { id } }: EventPageProps) => {
    ...
    return (
        <>
            ...
            {data.agenda.length > 0 && <section className={'p-8 lg:p-24 lg:px-0'}>
                                ...
                                <div className="p-1 h-full max-h-80">
                                    ...
                                    >
                                        <CardHeader>
                                            ...
                                            <CardDescription>
                                                {agenda.starts_at} - {agenda.ends_at}
                                            </CardDescription>
                                        </CardHeader>
                                        <CardContent>
            ...
            {data.type === 'Upcoming' && (
                <section className={'p-8 lg:p-24 bg-secondary'}>
                    <p className="text-muted text-xl lg:text-2xl mb-4 ">
                       {data.agenda[0]?.date} {data.agenda.length >= 2 && "-"} {data.agenda[data.agenda.length-1]?.date} 
                    </p>
            ...
            {(data.type === 'Past' && data.flashbackImageLinks.length !== 0) && (
